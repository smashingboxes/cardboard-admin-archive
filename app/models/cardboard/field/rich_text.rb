module Cardboard
  class Field::RichText < Field
    ...
    def sanitize_value
      ...
      self[:value_uid] = ActionController::Base.helpers.sanitize(self.value, :tags => %w(strong b i em br p div span ul ol li a pre code blockquote h1 h2 h3), :attributes => %w(class style href src width height alt))
    end
  end
end